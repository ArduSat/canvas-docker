...
export CANVAS_LMS_ADMIN_EMAIL="duane@ardusat.com"
export CANVAS_LMS_ADMIN_PASSWORD="canvascanvas"
export CANVAS_LMS_ACCOUNT_NAME="Ardusat"
...
psql -U canvas -d canvas_development -c "INSERT INTO access_tokens (created_at, crypted_token, developer_key_id, purpose, token_hint, updated_at, user_id) SELECT now(), '4bb5b288bb301d3d4a691ebff686fc67ad49daa8', dk.id, 'canvas-docker', '', now(), 1 FROM developer_keys dk where dk.email = '$CANVAS_LMS_ADMIN_EMAIL';"
